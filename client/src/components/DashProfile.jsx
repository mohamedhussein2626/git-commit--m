...
import { updateStart , updateFailure , updateSuccess , deleteUser , deleteUserFilure , deleteUserStart , signoutSuccess } from "../redux/user/userSlice";
...
const DashProfile = () => {
  ...
  const uploadImage = async()=> {
   ...
   const handleSubmit = async(e)=>{
    ...
    if(Object.keys(formData).length === 0){
      setUpdateUserError("please fill all inputs to make a change ...")
      return;
    }
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      <h1 className="my-7 text-center font-bold text-2xl">Profile</h1>
      ...
      <div className="text-red-500 flex justify-between font-bold mt-6">
        ...
        <Modal.Body>
          <div className="text-center">
                <HiOutlineExclamationCircle  className='h-14 w-14 text-gray-400 dark:text-gray-200 mb-4 mx-auto' />
                 <h3 className="uppercase mt-5 text-lg text-slate-500  dark:text-gray-200 ">
